...
class ModuleCoordinator(RustCoordinator):
    """Rust-backed coordinator with Python process_hook_result.

    Extends RustCoordinator with the process_hook_result method and its
    helpers, which route hook actions to approval_system and display_system.
    These live in Python because they call Python-only subsystems.
    """
