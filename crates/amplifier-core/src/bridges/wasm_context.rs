...
impl ContextManager for WasmContextBridge {
    fn add_message(
        ...
        Box::pin(async move {
            let message_bytes = serde_json::to_vec(&message).map_err(|e| ContextError::Other {
    ...
    fn get_messages_for_request(
        ...
        Box::pin(async move {
            ...
            let params_bytes = serde_json::to_vec(&params).map_err(|e| ContextError::Other {
